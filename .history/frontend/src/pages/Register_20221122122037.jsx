    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                <label> Email</label>
                {errors?.Email && <span style={{color:'red'}}>{errors?.Email?.message || 'Поля обязательно'}<FontAwesomeIcon icon={faCheck} /></span>}
                {!errors.Email  && <span style={{color:'green'}}><FontAwesomeIcon icon={faCheck} /></span>}
                <MyInput  
                    name='email'
                    type='email'
                    autoComplete="off"
