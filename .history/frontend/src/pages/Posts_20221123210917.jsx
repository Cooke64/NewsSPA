...
export default function Posts() {
      ...
      const [fetchPost, isPostsLoading] = useFetching((author, limit, page) => {
        const postAuthor = filter.author
        api.getPostList({postAuthor, limit, page})
        .then(res => {
      ...
      useEffect(()=> {
        fetchPost(filter.author, limit, page)
      }, [page, filter.author])
